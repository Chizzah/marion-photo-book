        ...
        this.textPhotographer = 
            <p style={{ maxWidth: "400px", color: "black" }}>
                <a href={config.linkPhotographer} target="_blank" rel="noopener noreferrer">
                    Elmine Botha
                </a> was our wonderful photographer.
            </p>

        this.textVenue = 
        <p style={{ maxWidth: "400px", color: "black" }}>
            <a href={config.linkVenue} target="_blank" rel="noopener noreferrer">
                Weddings by CW
            </a> planned our beautiful wedding.
        </p>
                ...
                <center>
                    <div>
                        <span onClick={() => this.handleTextChange(this.textDownload)} style={{ cursor: "pointer" }}>
                            Download photos
                        </span> | <span onClick={() => this.handleTextChange(this.textPhotographer)} style={{ cursor: "pointer" }}>
                            Behind the camera
                        </span> | <span onClick={() => this.handleTextChange(this.textVenue)} style={{ cursor: "pointer" }}>
                            Behind the wedding
                        </span>
