  ...
  render () {
    ...
    return (
      <>
        <Helmet>
          <meta charSet="utf-8" />
          <title>{`For Marion` /* Note: not a good idea to put image id here (needs JS to render the correct id). */}</title>
          ...
          <style>
            ...
            */}
            {`
              ...
              body {
                height: 100%;
                background-color: rgba(213, 150, 150, 0.4);
                margin: 0 0 0 0;
